...
#local host 24.2.25 SONN原整数据集
# parser.add_argument("-train_path", type=str, default="D:\\Users\\Administrator\\Desktop\\dataset_24_2_25\\ScanObjectNN_render_whole_renamed\\*\\train")   #训练集
# parser.add_argument("-val_path", type=str, default="D:\\Users\\Administrator\\Desktop\\dataset_24_2_25\\ScanObjectNN_render_whole_renamed\\*\\test")   #测试、验证集、预测及？

#modelnet40 localhost 24.4.5
parser.add_argument("-train_path", type=str, default="D:\\Python_Projects\\datasetforMVCNN\\modelnet40\\*\\train")   #训练集
parser.add_argument("-val_path", type=str, default="D:\\Python_Projects\\datasetforMVCNN\\modelnet40\\*\\test")   #测试、验证集、预测及？


#remote host
# parser.add_argument("-train_path", type=str, default="/root/autodl-tmp/Project_MVCNN_origin/ScanObjectNN_render_selected_renamed/*/train")   #训练集
# parser.add_argument("-val_path", type=str, default="/root/autodl-tmp/Project_MVCNN_origin/ScanObjectNN_render_selected_renamed/*/test")
